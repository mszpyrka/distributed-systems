...
if 'InvalidPeselException' not in _M_Accounts.__dict__:
    _M_Accounts.InvalidPeselException = Ice.createTempClass()
    class InvalidPeselException(_M_Accounts.GenericException):
        def __init__(self, message=''):
            _M_Accounts.GenericException.__init__(self, message)
    ...
    _M_Accounts._t_InvalidPeselException = IcePy.defineException('::Accounts::InvalidPeselException', InvalidPeselException, (), False, _M_Accounts._t_GenericException, ())
...
if 'BankManagerPrx' not in _M_Accounts.__dict__:
    ...
    BankManager._op_recoverAccountAccess = IcePy.Operation('recoverAccountAccess', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), IcePy._t_string, False, 0),), (), ((), _M_Accounts._t_AccountAccess, False, 0), (_M_Accounts._t_AuthenticationFailedException, _M_Accounts._t_InvalidPeselException))
